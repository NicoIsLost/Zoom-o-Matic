...
//		And if you were to add more key bindings, you get automatic support
	...
	private static double getCurrentZoomModifier() {
		...
		double modifier = 0;
		// It would be nice to link the binding and the config directly, but small steps
		switch (keyBind) {
			case LEVEL_1 -> modifier = CONFIG.Zoom1();
			case LEVEL_2 -> modifier = CONFIG.Zoom2();
			case LEVEL_3 -> modifier = CONFIG.Zoom3();
		}
		return modifier;
	}
